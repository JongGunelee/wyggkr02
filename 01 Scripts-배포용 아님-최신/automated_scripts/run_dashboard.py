...
"""
================================================================================
🚀 대시보드 서버 엔진 (Dashboard Server Engine) v2.6 [Enhanced Stability]
================================================================================
...
- v2.6 업데이트: 하트비트 타임아웃 300초로 대폭 상향 (안정성 강화), 창 닫기 연동 최적화
================================================================================
"""
...
# [이식성 강화] 상위 디렉토리(루트인 01 Scripts)를 기준으로 절대 경로 산정
...
class RequestHandler(http.server.SimpleHTTPRequestHandler):
    ...
    def _handle_run(self):
        ...
        try:
            ...
            # [이식성 강화] 전역 BASE_DIR을 사용하여 절대 경로 구성
            ...
            elif script_name.endswith('.md'):
                # [v2.3] MD 파일은 'start' 명령어를 통해 쉘 전면 활성화를 유도함
                try:
...
def start_server():
    ...
    # [이식성 강화] 하위 폴더에서 기동되더라도 작업 디렉토리를 루트인 01 Scripts 폴더로 고정
    os.chdir(BASE_DIR)
