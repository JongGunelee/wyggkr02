 ...
 */
extern "C" DWORD APIENTRY BT_GetFlags(void)
{
	return g_dwFlags;
}
 ...
 */
extern "C" void APIENTRY BT_SetFlags(DWORD dwFlags)
{
	g_dwFlags = dwFlags;
}
 ...
 * @return determines how the exception is handled.
 */
extern "C" LONG CALLBACK BT_SehFilter(PEXCEPTION_POINTERS pExceptionPointers)
{
 ...
 * @return determines how the exception is handled.
 */
extern "C" LONG CALLBACK BT_CppFilter(PEXCEPTION_POINTERS pExceptionPointers)
{
 ...
 * @return determines how the exception is handled.
 */
extern "C" LONG CALLBACK BT_NetFilter(PEXCEPTION_POINTERS pExceptionPointers)
{
#ifdef _MANAGED
 ...
 */
extern "C" PCTSTR APIENTRY BT_GetAppName(void)
{
	return g_szAppName;
}
 ...
 */
extern "C" void APIENTRY BT_SetAppName(PCTSTR pszAppName)
{
	if (pszAppName)
 ...
 */
extern "C" PCTSTR APIENTRY BT_GetAppVersion(void)
{
 ...
 */
extern "C" void APIENTRY BT_SetAppVersion(PCTSTR pszAppVersion)
{
	if (pszAppVersion)
 ...
 */
extern "C" PCTSTR APIENTRY BT_GetSupportURL(void)
{
 ...
 */
extern "C" void APIENTRY BT_SetSupportURL(PCTSTR pszSupportURL)
{
	if (pszSupportURL)
 ...
 */
extern "C" PCTSTR APIENTRY BT_GetSupportEMail(void)
{
 ...
 */
extern "C" void APIENTRY BT_SetSupportEMail(PCTSTR pszSupportEMail)
{
	if (pszSupportEMail)
 ...
 */
extern "C" PCTSTR APIENTRY BT_GetNotificationEMail(void)
{
 ...
 */
extern "C" void APIENTRY BT_SetNotificationEMail(PCTSTR pszNotificationEMail)
{
 ...
 */
extern "C" PCTSTR APIENTRY BT_GetSupportHost(void)
{
 ...
 */
extern "C" SHORT APIENTRY BT_GetSupportPort(void)
{
 ...
 */
extern "C" void APIENTRY BT_SetSupportHost(LPCTSTR pszSupportHost)
{
	if (pszSupportHost)
 ...
 */
extern "C" void APIENTRY BT_SetSupportPort(SHORT nSupportPort)
{
 ...
 * @param nSupportPort - port number of product support server where BugTrapServer is installed.
 */
extern "C" void APIENTRY BT_SetSupportServer(PCTSTR pszSupportHost, SHORT nSupportPort)
{
	BT_SetSupportHost(pszSupportHost);
	BT_SetSupportPort(nSupportPort);
}

extern "C" void APIENTRY BT_ClearLogFiles(void)
{
	g_arrLogLinks.DeleteAll(true);
}
 ...
 */
extern "C" DWORD APIENTRY BT_GetLogFilesCount(void)
{
 ...
 * @return error status.
 */
extern "C" DWORD APIENTRY BT_GetLogFileEntry(INT_PTR nLogFileIndexOrName, BOOL bGetByIndex, BUGTRAP_LOGTYPE* peLogType, PDWORD pdwLogEntrySize, PVOID pLogEntry)
{
	if (bGetByIndex)
	{
 ...
 * @param pszLogFile - custom log file name.
 */
extern "C" void APIENTRY BT_AddLogFile(PCTSTR pszLogFile)
{
 ...
 */
extern "C" void APIENTRY BT_AddRegFile(LPCTSTR pszRegFile, PCTSTR pszRegKey)
{
 ...
 * @param pszLogFile - custom log file name.
 */
extern "C" void APIENTRY BT_DeleteLogFile(PCTSTR pszLogFile)
{
	if (pszLogFile && *pszLogFile)
	{
 ...
 */
extern "C" BT_ErrHandler APIENTRY BT_GetPreErrHandler(void)
{
 ...
 */
extern "C" void APIENTRY BT_SetPreErrHandler(BT_ErrHandler pfnPreErrHandler, INT_PTR nPreErrHandlerParam)
{
 ...
 */
extern "C" BT_ErrHandler APIENTRY BT_GetPostErrHandler(void)
{
 ...
 */
extern "C" void APIENTRY BT_SetPostErrHandler(BT_ErrHandler pfnPostErrHandler, INT_PTR nPostErrHandlerParam)
{
 ...
 */
extern "C" PCTSTR APIENTRY BT_GetLogFileName(INT_PTR iHandle)
{
	CLogFile* pLogFile = EnterLogFunction(iHandle);
	if (! pLogFile)
		return NULL;
 ...
 */
extern "C" DWORD APIENTRY BT_GetLogSizeInEntries(INT_PTR iHandle)
{
	CLogFile* pLogFile = EnterLogFunction(iHandle);
	if (! pLogFile)
		return 0;
 ...
 */
extern "C" BOOL APIENTRY BT_SetLogSizeInEntries(INT_PTR iHandle, DWORD dwLogSizeInEntries)
{
	CLogFile* pLogFile = EnterLogFunction(iHandle);
	if (! pLogFile)
		return FALSE;
 ...
 * @return maximum size of log file in records.
 */
extern "C" DWORD APIENTRY BT_GetLogSizeInBytes(INT_PTR iHandle)
{
	CLogFile* pLogFile = EnterLogFunction(iHandle);
	if (! pLogFile)
		return 0;
 ...
 * @return true if operation was accepted.
 */
extern "C" BOOL APIENTRY BT_SetLogSizeInBytes(INT_PTR iHandle, DWORD dwLogSizeInBytes)
{
	CLogFile* pLogFile = EnterLogFunction(iHandle);
	if (! pLogFile)
		return FALSE;
 ...
 */
extern "C" DWORD APIENTRY BT_GetLogFlags(INT_PTR iHandle)
{
	CLogFile* pLogFile = EnterLogFunction(iHandle);
	if (! pLogFile)
		return BTLF_NONE;
 ...
 * @return true if operation was completed successfully.
 */
extern "C" BOOL APIENTRY BT_SetLogFlags(INT_PTR iHandle, DWORD dwLogFlags)
{
	CLogFile* pLogFile = EnterLogFunction(iHandle);
	if (! pLogFile)
		return FALSE;
 ...
 */
extern "C" BUGTRAP_LOGLEVEL APIENTRY BT_GetLogLevel(INT_PTR iHandle)
{
	CLogFile* pLogFile = EnterLogFunction(iHandle);
	if (! pLogFile)
		return BTLL_NONE;
 ...
 * @return true if operation was completed successfully.
 */
extern "C" BOOL APIENTRY BT_SetLogLevel(INT_PTR iHandle, BUGTRAP_LOGLEVEL eLogLevel)
{
	CLogFile* pLogFile = EnterLogFunction(iHandle);
	if (! pLogFile)
		return FALSE;
 ...
 */
extern "C" DWORD APIENTRY BT_GetLogEchoMode(INT_PTR iHandle)
{
	CLogFile* pLogFile = EnterLogFunction(iHandle);
	if (! pLogFile)
		return BTLE_NONE;
 ...
 * @return true if operation was completed successfully.
 */
extern "C" BOOL APIENTRY BT_SetLogEchoMode(INT_PTR iHandle, DWORD dwLogEchoMode)
{
	CLogFile* pLogFile = EnterLogFunction(iHandle);
	if (! pLogFile)
		return FALSE;
...
extern "C" void CDECL BT_CallSehFilter(void)
{
	__try {
...
extern "C" void CDECL BT_CallCppFilter(void)
{
	__try {
		RaiseException(EXCEPTION_ACCESS_VIOLATION, 0, 0, NULL);
...
extern "C" void CDECL BT_CallNetFilter(void)
{
#ifdef _MANAGED
	__try {
		RaiseException(EXCEPTION_ACCESS_VIOLATION, 0, 0, NULL);
 ...
 * @return true if operation was completed successfully.
 */
extern "C" BOOL APIENTRY BT_InsLogEntry(INT_PTR iHandle, BUGTRAP_LOGLEVEL eLogLevel, PCTSTR pszEntry)
{
 ...
 * @return true if operation was completed successfully.
 */
extern "C" BOOL APIENTRY BT_AppLogEntry(INT_PTR iHandle, BUGTRAP_LOGLEVEL eLogLevel, PCTSTR pszEntry)
{
 ...
 * @return true if operation was completed successfully.
 */
extern "C" BOOL CDECL BT_AppLogEntryF(INT_PTR iHandle, BUGTRAP_LOGLEVEL eLogLevel, PCTSTR pszFormat, ...)
{
	va_list argList;
 ...
 * @return true if operation was completed successfully.
 */
extern "C" BOOL APIENTRY BT_AppLogEntryV(INT_PTR iHandle, BUGTRAP_LOGLEVEL eLogLevel, PCTSTR pszFormat, va_list argList)
{
 ...
 * @return true if operation was completed successfully.
 */
extern "C" BOOL CDECL BT_InsLogEntryF(INT_PTR iHandle, BUGTRAP_LOGLEVEL eLogLevel, PCTSTR pszFormat, ...)
{
	va_list argList;
	va_start(argList, pszFormat);
 ...
 * @return true if operation was completed successfully.
 */
extern "C" BOOL APIENTRY BT_InsLogEntryV(INT_PTR iHandle, BUGTRAP_LOGLEVEL eLogLevel, PCTSTR pszFormat, va_list argList)
{
 ...
 * @return true if operation was completed successfully.
 */
extern "C" BOOL APIENTRY BT_ClearLog(INT_PTR iHandle)
{
	CLogFile* pLogFile = EnterLogFunction(iHandle);
	if (! pLogFile)
		return FALSE;
 ...
 */
extern "C" DWORD APIENTRY BT_GetDumpType(void)
{
	return g_eDumpType;
}
 ...
 */
extern "C" void APIENTRY BT_SetDumpType(DWORD dwDumpType)
{
 ...
 */
extern "C" BUGTRAP_ACTIVITY APIENTRY BT_GetActivityType(void)
{
 ...
 */
extern "C" BUGTRAP_EXITMODE APIENTRY BT_GetExitMode(void)
{
	return g_eExitMode;
}
 ...
 */
extern "C" BUGTRAP_REPORTFORMAT APIENTRY BT_GetReportFormat(void)
{
 ...
 */
extern "C" void APIENTRY BT_SetReportFormat(BUGTRAP_REPORTFORMAT eReportFormat)
{
 ...
 */
extern "C" void APIENTRY BT_SetActivityType(BUGTRAP_ACTIVITY eActivityType)
{
 ...
 */
extern "C" void APIENTRY BT_SetExitMode(BUGTRAP_EXITMODE eExitMode)
{
 ...
 */
extern "C" PCTSTR APIENTRY BT_GetReportFilePath(void)
{
 ...
 */
extern "C" void APIENTRY BT_SetReportFilePath(PCTSTR pszReportFilePath)
{
 ...
 */
extern "C" PCTSTR APIENTRY BT_GetMailProfile(void)
{
 ...
 */
extern "C" void APIENTRY BT_SetMailProfile(PCTSTR pszMailProfile, PCTSTR pszMailPassword)
{
	if (pszMailProfile)
 ...
 */
extern "C" INT_PTR APIENTRY BT_OpenLogFile(PCTSTR pszLogFileName, BUGTRAP_LOGFORMAT eLogFormat)
{
	CLogFile* pLogFile;
	switch (eLogFormat)
	{
 ...
 * @return true if operation was completed successfully.
 */
extern "C" BOOL APIENTRY BT_CloseLogFile(INT_PTR iHandle)
{
 ...
 * @return true if operation was completed successfully.
 */
extern "C" BOOL APIENTRY BT_FlushLogFile(INT_PTR iHandle)
{
	CLogFile* pLogFile = EnterLogFunction(iHandle);
	if (! pLogFile)
		return FALSE;
 ...
 * @return user message.
 */
extern "C" PCTSTR APIENTRY BT_GetUserMessage(void)
{
 ...
 */
extern "C" void APIENTRY BT_SetUserMessage(PCTSTR pszUserMessage)
{
 ...
 */
extern "C" void APIENTRY BT_SetUserMessageFromCode(DWORD dwErrorCode)
{
 ...
 */
extern "C" BOOL APIENTRY BT_ReadVersionInfo(HMODULE hModule)
{
 ...
 */
extern "C" LPTOP_LEVEL_EXCEPTION_FILTER APIENTRY BT_InstallSehFilter(void)
{
	// Setup unhandled exception handler.
...
extern "C" void APIENTRY BT_UninstallSehFilter(void)
{
 ...
 * @param bOverride - true if SetUnhandledExceptionFilter() must be overridden.
 */
extern "C" void BT_InterceptSUEF(HMODULE hModule, BOOL bOverride)
{
 ...
 * @return message text.
 */
extern "C" LPCTSTR APIENTRY BT_GetDialogMessage(BUGTRAP_DIALOGMESSAGE eDialogMessage)
{
 ...
 */
extern "C" void APIENTRY BT_SetDialogMessage(BUGTRAP_DIALOGMESSAGE eDialogMessage, LPCTSTR pszMessage)
{
	CStrHolder* pstrDialogMessage = GetDialogMessage(eDialogMessage);
 ...
 */
extern "C" int APIENTRY BT_ExportRegistryKey(LPCTSTR pszRegFile, LPCTSTR pszRegKey)
{
	int nResult = -1;
	HKEY hRootKey;
	PCTSTR pszRegPath;
 ...
 */
extern "C" BOOL APIENTRY BT_SaveSnapshot(PCTSTR pszFileName)
{
	// Initialize snapshot.
 ...
 * @return true if operation has been completed successfully.
 */
extern "C" BOOL APIENTRY BT_SaveSnapshotEx(PEXCEPTION_POINTERS pExceptionPointers, PCTSTR pszFileName)
{
	// Initialize snapshot.
 ...
 * @return true if operation has been completed successfully.
 */
extern "C" BOOL APIENTRY BT_MailSnapshot(void)
{
	// Initialize snapshot.
	BOOL bFreeSymEngine = InitSnapshot();
	// Save snapshot.
 ...
 * @return true if operation has been completed successfully.
 */
extern "C" BOOL APIENTRY BT_MailSnapshotEx(PEXCEPTION_POINTERS pExceptionPointers)
{
	// Initialize snapshot.
	if (! InitSnapshot(pExceptionPointers))
		return FALSE;
 ...
 * @return true if operation has been completed successfully.
 */
extern "C" BOOL APIENTRY BT_SendSnapshot(void)
{
	// Initialize snapshot.
	BOOL bFreeSymEngine = InitSnapshot();
	// Save snapshot.
 ...
 * @return true if operation has been completed successfully.
 */
extern "C" BOOL APIENTRY BT_SendSnapshotEx(PEXCEPTION_POINTERS pExceptionPointers)
{
	// Initialize snapshot.
	if (! InitSnapshot(pExceptionPointers))
		return FALSE;
 ...
 */
extern "C" HMODULE APIENTRY BT_GetModule()
{
  return g_hModule;
}
 ...
 */
extern "C" void APIENTRY BT_SetModule(HMODULE hModule)
{
  g_hModule = hModule;
}
