...
xpr_rcode_t Thread::join(xpr_sint_t *aExitCode)
{
    ...
    if (mHandle.mHandle != XPR_NULL)
    {
        ...
        // [Win11 Optimization] Moved CloseHandle inside null check.
        // Calling CloseHandle(NULL) is undefined behavior and
        // Windows 11 has stricter handle validation that can trigger errors.
