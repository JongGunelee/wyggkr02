...
public:
    ...
    String(const xpr_wchar_t *aString, xpr_size_t aLength);
    String(const xpr_char_t *aString);
    String(const xpr_wchar_t *aString);
    String(const xpr_size_t aNumber, xpr_char_t aChar);
    String(const xpr_size_t aNumber, xpr_wchar_t aChar);
...
public:
    ...
    static CharSet get_char_set(void);

public:
    // element access
    const xpr_tchar_t& operator[] (xpr_size_t aPos) const;
    xpr_tchar_t&       operator[] (xpr_size_t aPos);
    const xpr_tchar_t& at(xpr_size_t aPos) const;
    xpr_tchar_t&       at(xpr_size_t aPos);

public:
    // modifier
    String& operator= (const String &aString);
    String& operator= (const xpr_char_t *aString);
    String& operator= (const xpr_wchar_t *aString);
    String& operator= (xpr_char_t aChar);
    String& operator= (xpr_wchar_t aChar);
    ...
    String& append(const xpr_wchar_t *aString, xpr_size_t aLength);
    String& append(const xpr_char_t *aString);
    String& append(const xpr_wchar_t *aString);
    String& append(xpr_size_t aNumber, xpr_char_t aChar);
    String& append(xpr_size_t aNumber, xpr_wchar_t aChar);
    String& append(Iterator aFirst, Iterator aLast);

    xpr_tchar_t       &front(void);
    const xpr_tchar_t &front(void) const;
    xpr_tchar_t       &back(void);
    const xpr_tchar_t &back(void) const;
    ...
    String&  assign(const xpr_wchar_t *aString, xpr_size_t aLength);
    String&  assign(const xpr_char_t *aString);
    String&  assign(const xpr_wchar_t *aString);
    String&  assign(xpr_size_t aNumber, xpr_char_t aChar);
    String&  assign(xpr_size_t aNumber, xpr_wchar_t aChar);
    ...
    String&  insert(xpr_size_t aPos, const xpr_wchar_t *aString, xpr_size_t aLength);
    String&  insert(xpr_size_t aPos, const xpr_char_t *aString);
    String&  insert(xpr_size_t aPos, const xpr_wchar_t *aString);
    String&  insert(xpr_size_t aPos, xpr_size_t aNumber, xpr_char_t aChar);
    String&  insert(xpr_size_t aPos, xpr_size_t aNumber, xpr_wchar_t aChar);
    ...
    String&  replace(xpr_size_t aPos, xpr_size_t aLength1, const xpr_wchar_t *aString, xpr_size_t aLength2);
    String&  replace(Iterator aIterator1, Iterator aIterator2, const xpr_char_t *aString, xpr_size_t aLength);
    String&  replace(Iterator aIterator1, Iterator aIterator2, const xpr_wchar_t *aString, xpr_size_t aLength);
    String&  replace(xpr_size_t aPos, xpr_size_t aLength, const xpr_char_t *aString);
    String&  replace(xpr_size_t aPos, xpr_size_t aLength, const xpr_wchar_t *aString);
    String&  replace(Iterator aIterator1, Iterator aIterator2, const xpr_char_t *aString);
    String&  replace(Iterator aIterator1, Iterator aIterator2, const xpr_wchar_t *aString);
    String&  replace(xpr_size_t aPos, xpr_size_t aLength, xpr_size_t aNumber, xpr_char_t aChar);
    String&  replace(xpr_size_t aPos, xpr_size_t aLength, xpr_size_t aNumber, xpr_wchar_t aChar);
    String&  replace(Iterator aIterator1, Iterator aIterator2, xpr_size_t aNumber, xpr_char_t aChar);
    String&  replace(Iterator aIterator1, Iterator aIterator2, xpr_size_t aNumber, xpr_wchar_t aChar);
    ...
    void     format_args(const xpr_wchar_t *aFormat, va_list aArgs);
    ...
    void     append_format_args(const xpr_wchar_t *aFormat, va_list aArgs);
...
public:
    // operations
    const xpr_tchar_t *c_str(void) const;

    const xpr_tchar_t *data(void) const;
...
protected:
    xpr_tchar_t *alloc(const xpr_size_t &aMinCapacity, xpr_size_t &aCapacity) const;
...
XPR_INLINE String operator+ (const xpr_wchar_t *aString1, const String &aString2)
{
    return String(aString1) += aString2;
}
...
XPR_INLINE String operator+ (xpr_wchar_t aChar, const String &aString)
{
    return String(1, aChar) += aString;
}
...
XPR_INLINE String operator+ (const String &aString1, const xpr_wchar_t *aString2)
{
    return String(aString1) += aString2;
}
...
XPR_INLINE String operator+ (const String &aString, xpr_wchar_t aChar)
{
    return String(aString) += aChar;
}
...
XPR_INLINE bool operator== (const xpr_wchar_t *aString1, const String &aString2)
{
    return (aString2.compare(aString1) == 0) ? true : false;
}
...
XPR_INLINE bool operator== (const String &aString1, const xpr_wchar_t *aString2)
{
    return (aString1.compare(aString2) == 0) ? true : false;
}
