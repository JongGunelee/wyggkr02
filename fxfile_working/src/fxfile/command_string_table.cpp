...
void CommandStringTable::loadCommands(void)
{
    ...
    mCommandString[ID_FILE_INTEGRITY_MONITOR]         = XPR_STRING_LITERAL("cmd.file_integrity_monitor");
    ...
    mCommandString[ID_EDIT_FILE_LOCK_MANAGER]         = XPR_STRING_LITERAL("cmd.file_lock_manager");
    ...
    mCommandString[ID_TOOL_WINDOW_PLACEMENT_LOCK]     = XPR_STRING_LITERAL("cmd.window_placement_lock");
    mCommandString[ID_TOOL_VIEW_PATH_LOCK]            = XPR_STRING_LITERAL("cmd.view_path_lock");
    ...
    mCommandString[ID_VIEW_UI_SCALE_175]              = XPR_STRING_LITERAL("cmd.view.ui_scale_175");
    mCommandString[ID_VIEW_UI_SCALE_200]              = XPR_STRING_LITERAL("cmd.view.ui_scale_200");
    mCommandString[ID_TOOL_CALCULATOR]                = XPR_STRING_LITERAL("cmd.calculator");
...
void CommandStringTable::loadCommandButtons(void)
{
    ...
    mCommandButtonString[ID_TOOL_CALCULATOR]          = XPR_STRING_LITERAL("tool_bar.cmd.calculator");
