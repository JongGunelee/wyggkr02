...
void FolderCtrl::getFullPath(HTREEITEM aTreeItem, xpr::string &aFullPath) const
{
    aFullPath.clear();
...
void FolderCtrl::OnGetdispinfo(NMHDR *aNmHdr, LRESULT *aResult) 
{
    ...
    *aResult = 0;
    ...
    if (sTvItem.mask & TVIF_IMAGE || sTvItem.mask & TVIF_SELECTEDIMAGE)
    {
        ...
        sAsyncIcon->mPidl              = fxfile::base::Pidl::clone(
            sTvItemData->mFullPidl);
...
void FolderCtrl::getCurPath(xpr::string &aCurPath) const
{
...
void FolderCtrl::setCustomFont(xpr_bool_t aCustomFont, xpr_tchar_t *aFontText)
{
    ...
    LOGFONT sLogFont = {0};
    ::fxfile::Option::getScaledFont(sLogFont, aCustomFont ? aFontText : XPR_NULL);
...
void FolderCtrl::setCustomFont(xpr_bool_t aCustomFont, CFont *aFont)
{
    ...
    {
        ::fxfile::Option::getScaledFont(sLogFont, XPR_NULL);
    }
...
void FolderCtrl::setChangeNotify(xpr::string aPath, xpr_bool_t aAllSubTree, xpr_bool_t aEnable)
{
