...
public:
    ...
    xpr_bool_t isWindowPlacementLocked(void) const;
    void setWindowPlacementLocked(xpr_bool_t aLocked);
    xpr_bool_t isViewPathLocked(void) const;
    void setViewPathLocked(xpr_bool_t aLocked);
    xpr_bool_t isViewSplitLocked(void) const;
    void setViewSplitLocked(xpr_bool_t aLocked);
    xpr_bool_t isClockLocked(void) const;
    void setClockLocked(xpr_bool_t aLocked);
    xpr_bool_t isShowClock(void) const;
    void setShowClock(xpr_bool_t aShow);
    void applyUIScale(void);
