...
#define CMID_7ZIP_COMPRESS_7Z       0xFFF0
#define CMID_7ZIP_COMPRESS_ZIP      0xFFF1
#define CMID_7ZIP_COMPRESS_CUSTOM   0xFFF2
#define CMID_7ZIP_EXTRACT_HERE      0xFFF3
#define CMID_7ZIP_EXTRACT_TO_FOLDER 0xFFF4
#define CMID_7ZIP_EXTRACT_CUSTOM    0xFFF5
#define CMID_7ZIP_OPEN_ARCHIVE      0xFFF6
