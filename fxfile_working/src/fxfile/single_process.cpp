...
namespace
{
const xpr_tchar_t kSingleProcessMutexName[] = XPR_STRING_LITERAL("fxfile - single process");
const xpr_uint_t  WM_SINGLE_PROCESS         = ::RegisterWindowMessage(XPR_STRING_LITERAL("fxfile - single process"));
} // anonymous namespace
