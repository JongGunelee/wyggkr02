...
#ifndef __FXFILE_PATH_BAR_H__
#define __FXFILE_PATH_BAR_H__ 1
#pragma once
...
public:
    ...
    void setPathText(const xpr_tchar_t *aPathText);
...
protected:
    ...
    xpr_bool_t   mInArchiveBlink;
    xpr_bool_t   mBlinkState;
    UINT_PTR     mBlinkTimerId;
