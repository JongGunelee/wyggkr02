...
#ifndef __FXFILE_SHELL_CHANGE_NOTIFY_H__
#define __FXFILE_SHELL_CHANGE_NOTIFY_H__ 1
#pragma once
...
class ShellChangeNotify : public CWnd, public fxfile::base::Singleton<ShellChangeNotify>
{
    friend class fxfile::base::Singleton<ShellChangeNotify>;
...
protected:
    ...
    void insertQueue(HWND aHwnd, xpr_uint_t aMsg,
                     xpr_uint_t aWatchId,
...
protected:
    ...
    typedef std::set<xpr_uint_t> CancelledWatchSet;
    CancelledWatchSet mCancelledWatchSet;
...
#endif // __FXFILE_SHELL_CHANGE_NOTIFY_H__
