...
#ifndef __FXFILE_SEARCH_RESULT_PANE_H__
#define __FXFILE_SEARCH_RESULT_PANE_H__ 1
#pragma once
...
protected:
    ...
    virtual xpr_bool_t onOpenFolder(SearchResultCtrl &aSearchResultCtrl, LPCITEMIDLIST aFullPidl);
...
#endif // __FXFILE_SEARCH_RESULT_PANE_H__
