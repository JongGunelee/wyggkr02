...
public:
    ...
    typedef struct AsyncInfo
    {
        ...
        // Absolute PIDL.  The worker binds its own IShellFolder2 in its own
        // COM apartment instead of using a raw UI-apartment interface.
        LPITEMIDLIST    mPidl;
...
public:
    ...
    void cancelOwner(HWND aHwnd, xpr_uint_t aMsg);
