...
public:
    static struct Main
    {
        ...
        xpr_bool_t      mWindowPlacementLocked;
        xpr_bool_t      mViewPathLocked;
        xpr_tchar_t     mLockedViewPath[MAX_VIEW_SPLIT][XPR_MAX_PATH * 2 + 1];
        xpr_bool_t      mViewSplitLocked;
        xpr_bool_t      mClockLocked;
        xpr_bool_t      mShowClock;
        xpr_sint_t      mClockPosX;
        xpr_sint_t      mLockedViewSplitRowCount;
        xpr_sint_t      mLockedViewSplitColumnCount;
        xpr_double_t    mLockedViewSplitRatio[MAX_VIEW_SPLIT_COLUMN + MAX_VIEW_SPLIT_ROW - 2];
        xpr_sint_t      mLockedViewSplitSize[MAX_VIEW_SPLIT_COLUMN + MAX_VIEW_SPLIT_ROW - 2];
    ...
    static struct Config
    {
        ...
        xpr_bool_t      mFileListColumnEllipsisName;
        xpr_bool_t      mFileListColumnEllipsisSize;
        xpr_bool_t      mFileListColumnEllipsisType;
        xpr_bool_t      mFileListColumnEllipsisDate;
        xpr_bool_t      mFileListColumnEllipsisAttr;
        xpr_bool_t      mFileListColumnEllipsisExt;
