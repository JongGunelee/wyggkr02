...
public:
    enum DockTarget
    {
        DOCK_TARGET_ACTIVE = -1,
        DOCK_TARGET_PANE_1 = 0,
        DOCK_TARGET_PANE_2 = 1,
        DOCK_TARGET_PANE_3 = 2,
        DOCK_TARGET_PANE_4 = 3,
    };
    ...
    void setDockTarget(xpr_sint_t aTargetViewIndex);
    xpr_sint_t getDockTarget(void) const { return mDockTarget; }
    void updateDockedLayout(void);
    void reattachToTargetView(xpr_sint_t aTargetIndex = -1);
...
protected:
    ...
    xpr_bool_t mDocking;
    xpr_sint_t mDockTarget;
    xpr_bool_t mRatio;
    xpr_sint_t mLock;
    xpr_bool_t mAutoHide;
    xpr_bool_t mFileName;
    xpr_bool_t mHide;
    double     mDockZoomScale;
    CPoint     mDockPanOffset;
    CPoint     mPanStartPoint;
    xpr_bool_t mIsPanning;
...
protected:
    ...
    afx_msg void OnPicDockTargetActive(void);
    afx_msg void OnPicDockTargetPane1(void);
    afx_msg void OnPicDockTargetPane2(void);
    afx_msg void OnPicDockTargetPane3(void);
    afx_msg void OnPicDockTargetPane4(void);
    afx_msg void OnUpdatePicDockTargetActive(CCmdUI *aCmdUI);
    afx_msg void OnUpdatePicDockTargetPane1(CCmdUI *aCmdUI);
    afx_msg void OnUpdatePicDockTargetPane2(CCmdUI *aCmdUI);
    afx_msg void OnUpdatePicDockTargetPane3(CCmdUI *aCmdUI);
    afx_msg void OnUpdatePicDockTargetPane4(CCmdUI *aCmdUI);
