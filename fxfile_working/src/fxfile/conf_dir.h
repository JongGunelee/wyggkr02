...
public:
    enum
    {
        ...
        TypeLauncher,
        TypeUpchecker,
        // These files are part of the canonical user environment as well.
        // Keep them in the migration list when the configuration directory
        // is changed from the Options dialog.
        TypeViewSet,
        TypeUpdater,
        TypeEnd,
    };
