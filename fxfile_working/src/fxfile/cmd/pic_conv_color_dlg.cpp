...
namespace cmd
{
xpr_sint_t PicConvColorDlg::mIndex = 2;
xpr_sint_t PicConvColorDlg::mCurSel = 6;

PicConvColorDlg::PicConvColorDlg(const xpr_tchar_t *aPath)
...
void PicConvColorDlg::DoDataExchange(CDataExchange* pDX)
{
    super::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(PicConvColorDlg, super)
...
void PicConvColorDlg::initStaticVar(void)
{
    mIndex = 2;
    mCurSel = 6;
}

xpr_bool_t PicConvColorDlg::OnInitDialog(void) 
{
    super::OnInitDialog();
...
void PicConvColorDlg::getColorMode(GFL_MODE &aGflMode, GFL_MODE_PARAMS &aGflModeParams)
{
    aGflMode = mGflMode;
    aGflModeParams = mGflModeParams;
}

void PicConvColorDlg::enableWindow(xpr_sint_t aIndex)
{
    xpr_sint_t i;
    xpr_bool_t sEnable;
...
void PicConvColorDlg::OnRadioBinary(void) 
{
    enableWindow(0);
}

void PicConvColorDlg::OnRadioGrayscale(void) 
{
    enableWindow(1);
}

void PicConvColorDlg::OnRadioColor(void) 
{
    enableWindow(2);
}

void PicConvColorDlg::OnRadioTruecolor(void) 
{
    enableWindow(3);
}

void PicConvColorDlg::preOK(void)
{
...
void PicConvColorDlg::OnOK(void) 
{
    preOK();
...
void PicConvColorDlg::OnApplyAll(void) 
{
    mAllApply = XPR_TRUE;
    preOK();
