...
#ifndef __FXFILE_CMD_COMMAND_H__
#define __FXFILE_CMD_COMMAND_H__ 1
#pragma once
...
#define FXFILE_COMMAND_DECLARE_CLASS(CommandClass) \
...
#define FXFILE_COMMAND_DECLARE_CTRL \
...
#define FXFILE_COMMAND_ELSE_IF_FILE_SCRAP_PANE \
    else if (sFileScrapPane != XPR_NULL)

#define FXFILE_COMMAND_IF_FILE_SCRAP_PANE \
    if (sFileScrapPane != XPR_NULL)

#define FXFILE_COMMAND_ELSE_IF_SEARCH_RESULT_CTRL \
