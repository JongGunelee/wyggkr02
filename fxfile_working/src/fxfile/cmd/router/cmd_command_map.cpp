...
void CommandMap::map(CommandExecutor &aExecutor)
{
    ...
    aExecutor.bindCommand(ID_FILE_INTEGRITY_MONITOR,           new cmd::FileIntegrityMonitorCommand);
    ...
    aExecutor.bindCommand(ID_EDIT_FILE_LOCK_MANAGER,           new cmd::FileLockManagerCommand);
    ...
    aExecutor.bindCommand(ID_VIEW_PICVIEWER,                   new cmd::PictureViewerCommand);

    aExecutor.bindCommand(ID_VIEW_PIC_ZOOM_IN,                 new cmd::PictureViewerZoomInCommand);
    aExecutor.bindCommand(ID_VIEW_PIC_ZOOM_OUT,                new cmd::PictureViewerZoomOutCommand);
    aExecutor.bindCommand(ID_VIEW_PIC_ZOOM_100,                new cmd::PictureViewerZoom100Command);
    aExecutor.bindCommand(ID_VIEW_PIC_RATIO,                   new cmd::PictureViewerRatioResizeCommand);

    aExecutor.bindCommand(ID_VIEW_PIC_DOCKING,                 new cmd::PictureViewerDockingCommand);
    aExecutor.bindCommand(ID_VIEW_PIC_AUTO_HIDE,               new cmd::PictureViewerAutoHideCommand);

    aExecutor.bindCommand(ID_VIEW_PIC_LOCK,                    new cmd::PictureViewerLockImageCommand);
    aExecutor.bindCommand(ID_VIEW_PIC_CLIENT,                  new cmd::PictureViewerLockWindowCommand);
    aExecutor.bindCommand(ID_VIEW_PIC_LOCK_100,                new cmd::PictureViewerLock100Command);
    aExecutor.bindCommand(ID_VIEW_PIC_LOCK_THUMBNAIL,          new cmd::PictureViewerLockThumbnailCommand);

    aExecutor.bindCommand(ID_VIEW_PIC_SHOW_FILENAME,           new cmd::PictureViewerShowFileNameCommand);

    aExecutor.bindCommand(ID_VIEW_PIC_BACK_CENTER,             new cmd::PictureViewerBackgroundCenterCommand);
    aExecutor.bindCommand(ID_VIEW_PIC_BACK_TILE,               new cmd::PictureViewerBackgroundTitleCommand);
    aExecutor.bindCommand(ID_VIEW_PIC_BACK_STRETCH,            new cmd::PictureViewerBackgroundStretchCommand);

    aExecutor.bindCommand(ID_VIEW_PIC_SHOW_HIDE,               new cmd::PictureViewerToggleCommand);
    aExecutor.bindCommand(ID_VIEW_PIC_HIDE,                    new cmd::PictureViewerHideCommand);
    ...
    aExecutor.bindCommand(ID_TOOL_WINDOW_PLACEMENT_LOCK,       new cmd::WindowPlacementLockCommand);
    aExecutor.bindCommand(ID_TOOL_VIEW_PATH_LOCK,              new cmd::ViewPathLockCommand);
    aExecutor.bindCommand(ID_TOOL_VIEW_SPLIT_LOCK,             new cmd::ViewSplitLockCommand);
    aExecutor.bindCommand(ID_TOOL_CLOCK_LOCK,                  new cmd::ClockLockCommand);
    aExecutor.bindCommand(ID_TOOL_SHOW_CLOCK,                  new cmd::ShowClockCommand);
    aExecutor.bindCommand(ID_TOOL_CALCULATOR,                  new cmd::CalculatorCommand);
