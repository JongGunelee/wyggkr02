...
SearchUserLocDeque *SearchLocDlg::getSearchLoc(xpr_bool_t aNull)
{
    SearchUserLocDeque *sSearchUserLoc = mSearchUserLoc;
...
void SearchLocDlg::setSearchLoc(SearchUserLocDeque *aSearchUserLoc)
{
    SearchUserLoc *sSearchUserLoc;
    SearchUserLoc *sSearchUserLoc2;
    SearchUserLocDeque::iterator sIterator;
    UserLocDeque::iterator sUserLocIterator;
    SearchUserLocItem *sSearchUserLocItem;
    SearchUserLocItem *sSearchUserLocItem2;
    ...
    mSearchUserLoc = new SearchUserLocDeque;
    ...
    for (; sIterator != aSearchUserLoc->end(); ++sIterator)
    {
        ...
        sSearchUserLoc2 = new SearchUserLoc;
        ...
        for (; sUserLocIterator != sSearchUserLoc->mUserLocDeque.end(); ++sUserLocIterator)
        {
            ...
            sSearchUserLocItem2 = new SearchUserLocItem;
...
void SearchLocDlg::addLoc(SearchUserLoc *aSearchUserLoc, xpr_sint_t aIndex)
{
    if (aSearchUserLoc == XPR_NULL)
        return;
...
xpr_sint_t SearchLocDlg::addLocPath(SearchUserLocItem *aSearchUserLocItem, xpr_sint_t aIndex)
{
    if (aSearchUserLocItem == XPR_NULL)
        return -1;

    SearchUserLocItem *sSearchUserLocItem = new SearchUserLocItem;
    ...
    LPITEMIDLIST sFullPidl = fxfile::base::Pidl::create(sSearchUserLocItem->mPath.c_str());
...
void SearchLocDlg::setLocPath(void)
{
    ...
    SearchUserLoc *sSearchUserLoc = (SearchUserLoc *)mLocComboBox.GetItemData(sCurSel);
    if (sSearchUserLoc == XPR_NULL)
        return;
    ...
    for (i = 0; i < sCount; ++i)
    {
        sSearchUserLocItem = new SearchUserLocItem;
...
void SearchLocDlg::OnItemAdd(void) 
{
    ...
    SearchUserLocPathSet sUserLocPathSet;
...
void SearchLocDlg::OnItemModify(void) 
{
    ...
    SearchUserLocItem *sSearchUserLocItem = (SearchUserLocItem *)mListCtrl.GetItemData(sIndex);
    if (sSearchUserLocItem == XPR_NULL)
        return;
...
void SearchLocDlg::OnDeleteitemItemList(NMHDR* pNMHDR, LRESULT* pResult) 
{
    ...
    *pResult = 0;
    ...
    SearchUserLocItem *sSearchUserLocItem = (SearchUserLocItem *)pNMListView->lParam;
    if (sSearchUserLocItem == XPR_NULL)
        return;
...
void SearchLocDlg::OnOK(void) 
{
    ...
    for (i = 0; i < sCount; ++i)
    {
        sSearchUserLoc = (SearchUserLoc *)mLocComboBox.GetItemData(i);
        if (sSearchUserLoc == XPR_NULL)
            continue;
...
void SearchLocDlg::OnCbnSelchangeList(void)
{
    ...
    UserLocDeque::iterator sIterator = sSearchUserLoc->mUserLocDeque.begin();
...
void SearchLocDlg::OnCbenDeleteitemList(NMHDR *pNMHDR, LRESULT *pResult)
{
    ...
    *pResult = 0;
    ...
    SearchUserLoc *sSearchUserLoc = (SearchUserLoc *)pCBEx->ceItem.lParam;
    if (sSearchUserLoc == XPR_NULL)
        return;
...
void SearchLocDlg::OnListNew(void)
{
    ...
    SearchUserLoc *sSearchUserLoc = new SearchUserLoc;
    if (sSearchUserLoc == XPR_NULL)
        return;
