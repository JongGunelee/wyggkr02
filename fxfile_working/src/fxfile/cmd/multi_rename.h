...
public:
    enum
    {
        // This is a bit mask, not an ordinal.  With the old zero value,
        // XPR_TEST_BITS(flags, 0) was unconditionally true.
        FlagReadOnlyRename = (1u << 0),
    };
...
public:
    ...
    xpr_bool_t getItemOldName(xpr_size_t aIndex, xpr::string &aOldName);
