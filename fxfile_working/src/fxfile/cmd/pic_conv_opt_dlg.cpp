...
void PicConvOptDlg::DoDataExchange(CDataExchange* pDX)
{
    super::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(PicConvOptDlg, super)
    ON_WM_HSCROLL()
    ON_EN_UPDATE(IDC_PIC_CONV_OPTION_QUALITY, OnUpdateQuality)
END_MESSAGE_MAP()

xpr_bool_t PicConvOptDlg::OnInitDialog(void) 
{
    super::OnInitDialog();
...
void PicConvOptDlg::OnHScroll(xpr_uint_t nSBCode, xpr_uint_t nPos, CScrollBar* pScrollBar) 
{
...
void PicConvOptDlg::OnUpdateQuality(void) 
{
