...
public:
    ...
    xpr_sint_t completeDeferredStartupInit(void);
    void completeDeferredStartupHistory(void);
...
protected:
    ...
    xpr_sint_t initializeStartupView(void);
...
protected:
    ...
    xpr_bool_t     mInit;
    xpr_bool_t     mStartupInitPending;
    xpr_bool_t     mStartupHistoryPending;
