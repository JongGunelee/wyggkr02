    ...
    [
        {
            ...
            [
                ...
                './file_op_thread.cpp',
                './adaptive_file_operation.cpp',
                './adaptive_file_operation.h',
                './modern_shell_file_operation.cpp',
                './modern_shell_file_operation.h',
                './file_operation_lock_store.cpp',
                './file_operation_lock_store.h',
                './cmd/cmd_file_lock.cpp',
                './cmd/cmd_file_lock.h',
                './cmd/file_lock_manager_dlg.cpp',
                './cmd/file_lock_manager_dlg.h',
                './file_op_thread.h',
                './file_op_undo.cpp',
                './file_op_undo.h',
                './file_scrap.cpp',
