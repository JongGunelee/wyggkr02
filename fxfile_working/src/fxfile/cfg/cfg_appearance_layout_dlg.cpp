...
void CfgAppearanceLayoutDlg::onInit(const Option::Config &aConfig)
{
    ...
    ((CButton *)GetDlgItem(IDC_CFG_LAYOUT_INFO_BAR_NO_DISP_DETAILED_INFO))->SetCheck(aConfig.mContentsNoDispDetailedInfo);
...
void CfgAppearanceLayoutDlg::onApply(Option::Config &aConfig)
{
    ...
    aConfig.mContentsNoDispDetailedInfo = ((CButton *)GetDlgItem(IDC_CFG_LAYOUT_INFO_BAR_NO_DISP_DETAILED_INFO))->GetCheck();
