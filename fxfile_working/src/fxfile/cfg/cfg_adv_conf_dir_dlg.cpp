...
void CfgAdvConfDirDlg::onApply(Option::Config &aConfig)
{
    ...
    {
        // fxfile-main.conf can still be the pending source of the lazily
        // loaded recent-file list. Materialize it before the file is moved.
        RecentFileList::instance().prepareForConfigDirMove();
