...
xpr_bool_t CfgFuncRenameDlg::OnInitDialog(void) 
{
    ...
    SetDlgItemText(IDC_CFG_RENAME_GROUP_COMMAND,                   gApp.loadString(XPR_STRING_LITERAL("popup.cfg.body.function.rename.group.command")));
    SetDlgItemText(IDC_CFG_RENAME_BATCH_RENAME_ON_MULTI_SEL_ITEMS, gApp.loadString(XPR_STRING_LITERAL("popup.cfg.body.function.rename.check.batch_reanme_on_multiple_selected_items")));
    SetDlgItemText(IDC_CFG_RENAME_BATCH_RENAME_WITH_FOLDER,        gApp.loadString(XPR_STRING_LITERAL("popup.cfg.body.function.rename.check.batch_reanme_with_folder")));
    SetDlgItemText(IDC_CFG_RENAME_BY_MOUSE,                        gApp.loadString(XPR_STRING_LITERAL("popup.cfg.body.function.rename.check.rename_by_mouse")));
    SetDlgItemText(IDC_CFG_RENAME_GROUP_SINGLE_RENAME,             gApp.loadString(XPR_STRING_LITERAL("popup.cfg.body.function.rename.group.single_rename")));
    SetDlgItemText(IDC_CFG_RENAME_SINGLE_RENAME_DEFAULT,           gApp.loadString(XPR_STRING_LITERAL("popup.cfg.body.function.rename.radio.single_rename_default")));
    SetDlgItemText(IDC_CFG_RENAME_SINGLE_RENAME_BY_POPUP,          gApp.loadString(XPR_STRING_LITERAL("popup.cfg.body.function.rename.radio.single_rename_by_popup")));
    SetDlgItemText(IDC_CFG_RENAME_SINGLE_RENAME_BY_BATCH_RENAME,   gApp.loadString(XPR_STRING_LITERAL("popup.cfg.body.function.rename.radio.single_rename_by_batch_rename")));
    SetDlgItemText(IDC_CFG_RENAME_GROUP_EXT,                       gApp.loadString(XPR_STRING_LITERAL("popup.cfg.body.function.rename.group.extension")));
    SetDlgItemText(IDC_CFG_RENAME_EXT_DEFAULT,                     gApp.loadString(XPR_STRING_LITERAL("popup.cfg.body.function.rename.radio.extension_default")));
    SetDlgItemText(IDC_CFG_RENAME_EXT_KEEP,                        gApp.loadString(XPR_STRING_LITERAL("popup.cfg.body.function.rename.radio.extension_keep")));
    SetDlgItemText(IDC_CFG_RENAME_EXT_SEL_EXCEPT_FOR_EXT,          gApp.loadString(XPR_STRING_LITERAL("popup.cfg.body.function.rename.radio.extension_select_except_for_extension")));
